	...
	return (
		<React.Fragment>
			<div>
				...
				<p className="mt-2">
					Below is returned data from the open procedure. It does not require
					authentication or authorization. However, if you are authenticated it
					will still include your email.
				</p>
			</div>
